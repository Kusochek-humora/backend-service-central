...
const eventSchema = {
  ...
  properties: {
    ...
    gatheringTime: { type: ["string", "null"] },
...
const eventProperties = {
  ...
  date: { type: "string", description: "YYYY-MM-DD" },
  time: { type: "string", description: "HH:MM" },
  gatheringTime: { type: "string", description: "Время сбора HH:MM (опционально)" },
  ...
  banner: { type: "string", description: "URL баннера (опционально)" },
